...
const createUpdatePasswordSchema = zod
  .object({
    password: zod
...
export type CreateUpdatePasswordPayload = zod.infer<
  typeof createUpdatePasswordSchema
>

export default createUpdatePasswordSchema
